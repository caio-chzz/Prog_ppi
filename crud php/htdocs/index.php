...
<body>
    <h1>Bem-vindo à Doceria raimundo sc</h1>
...
function excluirDoce(doceId) {
        ...
        window.location.href = 'doces/excluir.php?id=' + doceId;
    
}

function editarDoce(doceId) {
    window.location.href = 'doces/editar.php?id=' + doceId;
}

function abreCadastro() {
    
    window.location.href = 'doces/criar.php';
}
</script>
</body>
</html>